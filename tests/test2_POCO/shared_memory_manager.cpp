...
int main() {
    try {
        // Crear un archivo para la memoria compartida
        ...
        // Crear un manejador de memoria compartida usando el constructor con nombre
        ...
        // Mostrar la información del manejador
